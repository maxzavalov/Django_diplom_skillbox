...
class Cart(object):
    ...
    def __init__(self, request):
        """Инициализация экземпляра корзины в текущей сессии"""
    ...
    def __iter__(self):
        """Сортировка товаров в корзине и получение их из базы данных"""
    ...
    def add(self, product, quantity=1, override_quantity=False):
        """Добавление продукта в корзину либо обновление количества"""
        product_id = str(product.id)
