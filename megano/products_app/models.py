...
class Specification(models.Model):
    ...
    name = models.CharField(
        max_length=150, null=False, blank=True, verbose_name="Параметр"
    )
    value = models.CharField(
        max_length=200, null=False, blank=True, verbose_name="Значение"
    )
...
class Product(models.Model):
    ...
    price = models.DecimalField(
        default=0, max_digits=8, decimal_places=2, verbose_name="Стоимость"
    )
...
class ProductImage(models.Model):
    ...
    alt = models.CharField(
        max_length=128, default="Image alt string", verbose_name="Описание"
    )
