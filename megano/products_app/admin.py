...
class CategoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (("Категория", {"fields": (("title", "image", "parent"),)}),)
...
class ProductsAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Название и количество", {"fields": (("title", "count", "date"),)}),
        ("Описание товара", {"fields": (("description", "fullDescription"),)}),
        (
            "Статус товара",
            {
                "classes": ("collapse",),
        ...
        ("Теги и категории", {"fields": (("tags", "category"),)}),
        ("Спецификация", {"fields": (("specification",),)}),
    )
