...
urlpatterns = [
    ...
    path('products/popular', ProductPopularListAPIView.as_view(), name="products_popular"),
    path('products/limited', ProductLimitedListAPIView.as_view(), name="products_limited"),
